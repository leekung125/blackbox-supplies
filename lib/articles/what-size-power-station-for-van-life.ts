...
export const WHAT_SIZE_POWER_STATION_FOR_VAN_LIFE: Article = {
  ...
  sections: [
    ...
    },
    {
      ...
      table: {
        caption: "The three stations, as our catalog's verified spec strings record them",
        columns: ["Station", "Capacity", "Continuous AC", "Surge / peak", "Weight", "What that means in a van"],
        rows: [
          [
            "EcoFlow RIVER 2 Pro",
            "768Wh LiFePO4",
    ...
    },
    {
      ...
      body: [
        ...
        "The contrast is what makes it worth checking. LiFePO4 — lithium iron phosphate, often written LFP — is rated in the thousands of cycles. The older NMC lithium chemistry that cheaper and older portable stations use is commonly rated in the hundreds. At one cycle a day, a few hundred cycles is a year or two, not a decade. That is the difference between a station that outlives the van and one you buy twice, and it is completely invisible on a comparison that only looks at watt-hours and price. If a listing does not say LiFePO4 or LFP anywhere, assume it is the other chemistry and ask before you buy. All three stations here are LiFePO4, though our catalog does not record a cycle figure for the Bluetti AC180 — check Bluetti's own spec page for that one rather than assuming it matches the Jackery.",
      ...
      table: {
        ...
        rows: [
          [
            ...
            "EcoFlow RIVER 2 Pro (768Wh, 17 lb)",
          ],
          [
  ...
  faq: [
    ...
    },
    {
      ...
      a: "It depends entirely on the source. From a wall socket, the manufacturers publish about 45 minutes to 80% for the Bluetti AC180, roughly an hour for the Jackery Explorer 1000 v2, and about 70 minutes to full for the EcoFlow RIVER 2 Pro. From solar you are capped by the station's published input ceiling — 220W, 400W and 500W respectively — and by real panel output, which runs well under the panel's rating. From the vehicle's 12V accessory socket it is a trickle: those sockets are typically fused around 120-180W, so at roughly 100W of real input a 1,000Wh refill is on the order of ten hours of driving.",
    },
    {
