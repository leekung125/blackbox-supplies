 ...
 *      space-heaters` 404s and the whole DOE Energy Saver section is gone (eight other links to
 *      it survive elsewhere in lib/articles — they are dead too); `bluettipower.com/products/
 *      bluetti-ac180-portable-power-station` is a redirect loop (28 hops, never resolves) while
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "A standard North American household circuit is 120 volts at 15 amps, which is 1,800 watts of theoretical capacity. The US National Electrical Code's continuous-load rule — a load that runs three hours or more — requires the circuit to be sized at 125% of that load, which is the same thing as capping the load at 80% of the breaker: 1,440W on a 15-amp circuit. That is why virtually every plug-in space heater sold in the US tops out at 1,500W, and why the manual tells you to give it its own outlet and no extension cord. It is not the manufacturers being conservative; it is the socket being the limit.",
    ...
    },
    {
      ...
      body: [
        "Here are the numbers from our catalog, run against the three heater settings you are most likely to have. Capacities and inverter ratings are the manufacturers' published figures as recorded in our catalog: BLUETTI AC180, 1,152Wh with an 1,800W inverter (2,700W peak); Jackery Explorer 1000 v2, 1,070Wh with a 1,500W inverter (3,300W surge); EcoFlow RIVER 2 Pro, 768Wh with an 800W native AC output; Anker SOLIX C300, 288Wh with a 300W AC output.",
    ...
    },
    {
      ...
      body: [
        ...
        "One more thing the listings never mention: in an outage you get exactly one tank. The AC180 recharges 0-80% in 45 minutes and the RIVER 2 Pro goes 0-100% in about 70 — both manufacturer figures as recorded in our catalog, and both measured from a wall outlet. During a power cut there is no wall outlet. Our catalog says the AC180's solar panel is sold separately; on the others, read the box contents before assuming a panel is included. A panel in December produces well below its rated watts, and most LiFePO4 packs specify a minimum charging temperature at or above freezing — check your own model's manual. Whatever is in the battery when the lights go out is the whole supply.",
      ],
    },
    {
    ...
    },
    {
      ...
      list: [
        ...
        "Do not plan on a recharge|One tank is the supply. Solar is sold separately on these units, winter output is well below rated, and most packs will not accept a charge below freezing.",
      ],
    },
    {
      ...
      body: [
        ...
        "The BLUETTI AC180 is the most runtime of the four, full stop: 1,152Wh of LiFePO4 and an 1,800W inverter, which is the only one of the four with genuine headroom above a 1,500W nameplate. It also carries a 20ms UPS switchover and a 0-80% recharge in 45 minutes, both BLUETTI's published figures. The honest costs, from our catalog's own notes: it is around 35 lb, which makes it a haul-it-there unit rather than a carry-it-around one; the solar panel is a separate purchase; and the cooling fan is audible under heavy load — and running a heater is the definition of heavy load, so expect to hear it.",
