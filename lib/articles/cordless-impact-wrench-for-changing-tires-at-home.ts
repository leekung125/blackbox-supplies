 ...
 * 330 ft-lbs figure is AVID POWER's own max-torque rating, and the install-vs-
...
export const CORDLESS_IMPACT_WRENCH_FOR_CHANGING_TIRES_AT_HOME: Article = {
  ...
  sections: [
    {
      ...
      table: {
        ...
        columns: ["Scenario", "Rough torque involved", "Does a 330 ft-lbs cordless clear it?"],
        rows: [
    ...
    },
    {
      ...
      list: [
        "Buy it if: you rotate your own tires or do your own brakes|Pulling four wheels for a rotation or a brake job is the exact use case. A 330 ft-lbs cordless turns the worst part of the job — breaking the lugs loose — into seconds, with no compressor to own or wheel out.",
        ...
        "Skip it if: your real problem is seized suspension or axle bolts|Rust-welded control-arm bolts, crank pulleys, and axle nuts routinely need far more than 330 ft-lbs. That's a job for a high-torque impact plus heat and penetrating oil — different tool, different budget.",
    ...
    },
    {
      ...
      list: [
        ...
        "Torque rating is a max, not a guarantee|'330 ft-lbs max' is the tool's ceiling under ideal conditions and fresh battery. A low battery, a badly fitting socket, or a very stuck nut all cut into real-world output — another reason the breaker bar backstop matters.",
  ...
  faq: [
    ...
    },
    {
      ...
      a: "Skip the sub-$100 tier if you're a pro or daily heavy user, or if your real jobs are seized suspension bolts, crank pulleys, and axle nuts — those routinely need 600+ ft-lbs plus heat and penetrating oil. A 330 ft-lbs value kit is built for home wheels, not all-day shop duty or rust-welded chassis hardware.",
    },
  ],
