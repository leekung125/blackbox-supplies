...
export const FANS_PRODUCTS: ProductFor<"fans">[] = [
  // ── Best overall (most capable + most flexible air placement) ──────────────
  {
    ...
    brand: "Shark",
    category: "fans",
    image: "/products/scene/shark-turboblade-bladeless-tower-fan-tf202s.webp",
    price: 290,
    priceRange: "$279–$300",
  ...
  // ── Best for bedrooms (quietest published) ─────────────────────────────────
  {
    ...
    brand: "Dreo",
    category: "fans",
    image: "/products/scene/dreo-42-inch-bladeless-tower-fan.webp",
    price: 90,
    priceRange: "$80–$100",
  ...
  // ── Best premium (fan + sealed HEPA purifier in one) ───────────────────────
  {
    ...
    brand: "Dyson",
    category: "fans",
    image: "/products/scene/dyson-purifier-cool-tp07-bladeless-tower.webp",
    price: 490,
    priceRange: "$430–$550",
  ...
  // ── Best value tower (biggest airflow number for the money) ────────────────
  {
    ...
    brand: "Dreo",
    category: "fans",
    image: "/products/scene/dreo-cruiser-pro-t1-oscillating-tower.webp",
    price: 100,
    priceRange: "$90–$110",
  ...
  // ── Best for outdoors / patio (misting + cordless) ─────────────────────────
  {
    ...
    brand: "Shark",
    category: "fans",
    image: "/products/scene/shark-flexbreeze-pro-mist-fan-fa302.webp",
    price: 214,
    priceRange: "$179–$249",
  ...
  // ── Best budget (cheapest, dependable slim tower) ──────────────────────────
  {
    ...
    brand: "Lasko",
    category: "fans",
    image: "/products/scene/lasko-wind-curve-2551-42-inch.webp",
    price: 68,
    priceRange: "$55–$80",
