...
export const TIRE_INFLATOR_PRODUCTS: ProductFor<"tire_inflators">[] = [
  // ── Best overall (do-it-all premium cordless) ──────────────────────────────
  {
    ...
    image: "/products/scene/fanttik-x8-apex-portable-tire.png",
    price: 80,
    priceRange: "$70–$90",
  ...
  // ── Best value (full cordless package, no tool ecosystem needed) ───────────
  {
    ...
    brand: "AstroAI",
    category: "tire_inflators",
    image: "/products/scene/astroai-cordless-tire-inflator-160.png",
    price: 57,
    priceRange: "$50–$65",
  ...
  // ── Best for versatility (three power sources) ─────────────────────────────
  {
    ...
    brand: "DeWalt",
    category: "tire_inflators",
    image: "/products/scene/dewalt-20v-max-corded-cordless.png",
    price: 99,
  ...
  // ── Best for tool owners (M12 ecosystem) ───────────────────────────────────
  {
    ...
    brand: "Milwaukee",
    category: "tire_inflators",
    image: "/products/scene/milwaukee-m12-compact-inflator-2475.png",
    price: 99,
    priceRange: "$99 (tool only)",
  ...
  // ── Premium design pick (big battery, best finish) ─────────────────────────
  {
    ...
    brand: "HOTO",
    category: "tire_inflators",
    image: "/products/scene/hoto-portable-tire-inflator-pro.png",
    price: 70,
    priceRange: "$60–$80",
  ...
  // ── Best budget (glovebox compact) ─────────────────────────────────────────
  {
    ...
    brand: "AstroAI",
    category: "tire_inflators",
    image: "/products/scene/astroai-l7-compact-cordless-tire.png",
    price: 40,
    priceRange: "$35–$45",
  ...
  // ── Best corded value (cheapest, always-ready) ─────────────────────────────
  {
    ...
    brand: "EPAuto",
    category: "tire_inflators",
    image: "/products/scene/epauto-12v-dc-portable-air.png",
    price: 35,
    priceRange: "$30–$40",
