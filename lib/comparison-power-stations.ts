...
export const POWER_STATION_PRODUCTS: ProductFor<"power_stations">[] = [
  // ── Best overall (most usable power + biggest battery per dollar) ───────────
  {
    ...
    image: "/products/scene/bluetti-ac180-portable-power-station.png",
    price: 549,
    priceRange: "$399–$699",
  ...
  // ── Best 1kWh all-rounder (lightest of the kilowatt class, fastest recharge) ─
  {
    ...
    brand: "Jackery",
    category: "power_stations",
    image: "/products/scene/jackery-explorer-1000-v2-portable.png",
    price: 624,
    priceRange: "$449–$799",
  ...
  // ── Best compact (real AC power that's still easy to carry) ─────────────────
  {
    ...
    brand: "EcoFlow",
    category: "power_stations",
    image: "/products/scene/ecoflow-river-2-pro-portable.png",
    price: 464,
    priceRange: "$329–$599",
  ...
  // ── Best budget (cheapest real LiFePO4 station; backpack-light) ─────────────
  {
    ...
    brand: "Anker",
    category: "power_stations",
    image: "/products/scene/anker-solix-c300-portable-power.png",
    price: 239,
    priceRange: "$179–$299",
  ...
  // ── Most portable (pocket power bank — NOT a station; no AC) ────────────────
  {
    ...
    brand: "Anker",
    category: "power_stations",
    image: "/products/scene/anker-prime-power-bank.png",
    price: 154,
    priceRange: "$129–$179",
