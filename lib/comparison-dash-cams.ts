...
export const DASH_CAMS_PRODUCTS: ProductFor<"dash_cams">[] = [
  // ── Best overall (reference-grade front + rear, dual STARVIS 2) ─────────────
  {
    ...
    brand: "VIOFO",
    category: "dash_cams",
    image: "/products/scene/viofo-a229-plus.webp",
    price: 230,
    priceRange: "$200–$260",
  ...
  // ── Best compact front cam (STARVIS 2 in a hideaway body) ──────────────────
  {
    ...
    brand: "VIOFO",
    category: "dash_cams",
    image: "/products/scene/viofo-a119-mini-2.webp",
    price: 115,
    priceRange: "$100–$130",
  ...
  // ── Best budget (default best-value 4K, huge track record) ─────────────────
  {
    ...
    brand: "ROVE",
    category: "dash_cams",
    image: "/products/scene/rove-r2-4k.webp",
    price: 105,
    priceRange: "$90–$120",
  ...
  // ── Best budget front + rear (value two-channel, card in the box) ──────────
  {
    ...
    brand: "REDTIGER",
    category: "dash_cams",
    image: "/products/scene/redtiger-f7n.webp",
    price: 145,
    priceRange: "$130–$160",
  ...
  // ── Best for rideshare / fleet (3-channel: front + cabin + rear) ───────────
  {
    ...
    brand: "VIOFO",
    category: "dash_cams",
    image: "/products/scene/viofo-a139-pro.webp",
    price: 330,
    priceRange: "$300–$360",
  ...
  // ── Best connected / smart (4G LTE, live view, Emergency SOS) ──────────────
  {
    ...
    brand: "Nextbase",
    category: "dash_cams",
    image: "/products/scene/nextbase-iq-4k-smart-dash.webp",
    price: 500,
    priceRange: "$400–$600",
  ...
  // ── Best discreet / trusted brand (key-fob-sized, set-and-forget) ──────────
  {
    ...
    brand: "Garmin",
    category: "dash_cams",
    image: "/products/scene/garmin-dash-cam-mini-2.webp",
    price: 130,
    priceRange: "$110–$150",
