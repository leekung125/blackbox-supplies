...
export const PORTABLE_AC_PRODUCTS: ProductFor<"portable_ac">[] = [
  // ── Best overall (real cooling power per watt) ─────────────────────────────
  {
    ...
    image: "/products/ac/midea-duo-14-000-btu-smart.png",
    price: 550,
    priceRange: "$500–$600",
  ...
  // ── Best for large rooms / most features ───────────────────────────────────
  {
    ...
    brand: "Whynter",
    category: "portable_ac",
    image: "/products/ac/whynter-nex-arc-1230wn-14-000.png",
    price: 650,
    priceRange: "$600–$700",
  ...
  // ── Best for bedrooms (quietest) ───────────────────────────────────────────
  {
    ...
    brand: "LG",
    category: "portable_ac",
    image: "/products/ac/lg-lp1419ivsm-dual-inverter-14000-btu.png",
    price: 674,
    priceRange: "$649–$699",
  ...
  // ── Best value dual-hose workhorse ─────────────────────────────────────────
  {
    ...
    brand: "Whynter",
    category: "portable_ac",
    image: "/products/ac/whynter-arc-14s-14000-btu-dual-hose.png",
    price: 525,
    priceRange: "$499–$549",
  ...
  // ── Premium design pick ────────────────────────────────────────────────────
  {
    ...
    brand: "De'Longhi",
    category: "portable_ac",
    image: "/products/ac/delonghi-pinguino-pacex390lvyn-14000-btu.png",
    price: 550,
    priceRange: "$500–$600",
  ...
  // ── Best budget ────────────────────────────────────────────────────────────
  {
    ...
    brand: "BLACK+DECKER",
    category: "portable_ac",
    image: "/products/ac/black-decker-10-000-btu-3.png",
    price: 340,
    priceRange: "$300–$380",
  ...
  // ── Cheapest / smallest room ───────────────────────────────────────────────
  {
    ...
    brand: "Shinco",
    category: "portable_ac",
    image: "/products/ac/shinco-spf1-08c-8000-btu.png",
    price: 260,
    priceRange: "$250–$270",
  ...
  // ── Best off-grid / cordless (different class — spot cooler) ────────────────
  {
    ...
    brand: "EcoFlow",
    category: "portable_ac",
    image: "/products/ac/ecoflow-wave-3-portable-air-conditioner.png",
    price: 1299,
