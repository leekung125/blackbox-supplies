...
export const JUMP_STARTER_PRODUCTS: ProductFor<"jump_starters">[] = [
  // ── Best overall (the category benchmark) ──────────────────────────────────
  {
    ...
    image: "/products/scene/noco-boost-gb40-1000a-ultrasafe.webp",
    price: 90,
    priceRange: "$80–$100",
  ...
  // ── Best for trucks / diesels (heavy-duty) ─────────────────────────────────
  {
    ...
    brand: "NOCO",
    category: "jump_starters",
    image: "/products/scene/noco-boost-hd-gb70-2000a.webp",
    price: 165,
    priceRange: "$150–$180",
  ...
  // ── Best smart display (premium, information-rich) ─────────────────────────
  {
    ...
    brand: "Hulkman",
    category: "jump_starters",
    image: "/products/scene/hulkman-alpha85-2000a-smart-jump.webp",
    price: 115,
    priceRange: "$100–$130",
  ...
  // ── Best value smart pick ──────────────────────────────────────────────────
  {
    ...
    brand: "Fanttik",
    category: "jump_starters",
    image: "/products/scene/fanttik-t8-apex-2000a-jump.webp",
    price: 110,
    priceRange: "$90–$130",
  ...
  // ── Most cranking power ────────────────────────────────────────────────────
  {
    ...
    brand: "GOOLOO",
    category: "jump_starters",
    image: "/products/scene/gooloo-gp4000-4000a-peak-lithium.webp",
    price: 110,
    priceRange: "$90–$130",
  ...
  // ── Best all-in-one (compressor + AC inverter) ─────────────────────────────
  {
    ...
    brand: "DeWalt",
    category: "jump_starters",
    image: "/products/scene/dewalt-dxaeps14-2000-peak-amp.webp",
    price: 225,
    priceRange: "$200–$250",
  ...
  // ── Best budget ────────────────────────────────────────────────────────────
  {
    ...
    brand: "GOOLOO",
    category: "jump_starters",
    image: "/products/scene/gooloo-gp2000-2000a-compact-lithium.webp",
    price: 70,
    priceRange: "$60–$80",
  ...
  // ── Best batteryless (no cells to age out) ─────────────────────────────────
  {
    ...
    brand: "Autowit",
    category: "jump_starters",
    image: "/products/scene/autowit-supercap-2-batteryless-supercapacitor.webp",
    price: 110,
    priceRange: "$90–$130",
